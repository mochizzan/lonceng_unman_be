...
//   BASE_URL=http://localhost:3000 NPM_A=2211700006 PASSWORD_A=Izzan027 node tmp/ttl-boundary-evidence.mjs --ttl 60 --json
...
Usage:
  ...
  BASE_URL=http://localhost:3000 NPM_A=2211700006 PASSWORD_A=xxx node tmp/ttl-boundary-evidence.mjs
